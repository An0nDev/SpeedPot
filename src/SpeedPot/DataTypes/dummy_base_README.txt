...
- an inner class called ReadResult with two fields, NR (named 'nr') and Common::FieldLength fieldLength (from Common.hpp), and a constructor that copy-constructs these from two arguments
